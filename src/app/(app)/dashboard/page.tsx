      ...
      <div className="content">
        ...
        <div className="grid grid-4" style={{ gap: 16 }}>
          <div className="dash-card" onClick={() => router.push('/prospect')}>
            ...
            <div style={{ width: 36, height: 36, borderRadius: 8, background: '#fef3c7', color: '#b45309', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 10 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
            </div>
          ...
          <div className="dash-card" onClick={() => router.push('/markets')}>
            ...
            <div style={{ width: 36, height: 36, borderRadius: 8, background: '#eff6ff', color: '#2563eb', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 10 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18M5 21V7l8-4v18M19 21V11l-6-4"/></svg>
            </div>
          ...
          <div className="dash-card" onClick={() => router.push('/analytics')}>
            ...
            <div style={{ width: 36, height: 36, borderRadius: 8, background: '#faf5ff', color: '#7c3aed', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 10 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></svg>
            </div>
          ...
          <div className="dash-card" onClick={() => router.push('/leaderboard')}>
            ...
            <div style={{ width: 36, height: 36, borderRadius: 8, background: '#fef3c7', color: '#854d0e', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 10 }}>
